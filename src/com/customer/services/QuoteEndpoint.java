...
import com.customer.entity.PMF;
import com.customer.entity.Quote;
...
@Api(name = "quoteendpoint", namespace = @ApiNamespace(ownerDomain = "customer.com", ownerName = "customer.com", packagePath = "entity"))
public class QuoteEndpoint {
	...
	public void initData() {
		...
		for (int i = 1; i < 100; i++) {
			...
			quote = new Quote((long)i, message, author);
			insertQuote(quote);
		}
